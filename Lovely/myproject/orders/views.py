...
def place_order(request, total=0, quantity=0,):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
                pt=form.cleaned_data['address_line_1']
                nm=form.cleaned_data['first_name']
                print(pt,'this address')
                if Address.objects.filter(user=request.user,name=nm,address=pt) :
                    check = True
                ...
                if check == False :
                    ...
                    add.name = form.cleaned_data['first_name']
                    add.address = form.cleaned_data['address_line_1']
